    ...
    def importar_csv(self, request):
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.success(request, f'¡Se cargaron {contador} servicios correctamente!')
                return redirect('..')
        else:
            form = CsvImportForm()
...
class PedidoAdmin(admin.ModelAdmin):
    list_display = ('id', 'cliente_nombre', 'servicio', 'estado', 'total','fecha')
    list_filter = ('estado', 'fecha')
    search_fields = ('cliente_nombre','servicio_nombre')